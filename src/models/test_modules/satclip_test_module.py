...
class DummyEnc(torch.nn.Module):
    def __init__(self, add_multiples):
        ...
        self.location_encoder = get_satclip('/home/jdolli/chelsaCLIP/src/utils/test_cases/scripts/satclip-resnet18-l40.ckpt', device="cuda") #Only loads location encoder by default
