...
class DSTs:
    ...
    def __call__(self, pos_embedding, location_encoder, wb, section=""):
        ...
        atr = ATR(
            "/home/jdolli/chelsaCLIP/src/utils/test_cases/data/stationDataAll.csv",
            mlp_input_len=self.mlp_input_len,
            use_months=self.use_months,
            pass_month_to_forward=self.pass_month_to_forward,
            verbose=self.verbose,
            iterations=self.iterations,
            linear_probing=self.linear_probing,
            train_loc_enc=self.train_loc_enc,
        )
        ...
        gcr = GCR(
            "/home/jdolli/chelsaCLIP/src/utils/test_cases/data/global_chelsa_100000.npy",
            mlp_input_len=self.mlp_input_len,
            use_months=self.use_months,
            pass_month_to_forward=self.pass_month_to_forward,
            verbose=self.verbose,
        ...
        calr = CalR(
            "/home/jdolli/chelsaCLIP/src/utils/test_cases/data/housing.csv",
            mlp_input_len=self.mlp_input_len,
            use_months=self.use_months,
            pass_month_to_forward=self.pass_month_to_forward,
            verbose=self.verbose,
        ...
        pdr = PDR(
            "/home/jdolli/chelsaCLIP/src/utils/test_cases/data/pop_density_us_100000.npy",
            mlp_input_len=self.mlp_input_len,
            use_months=self.use_months,
            pass_month_to_forward=self.pass_month_to_forward,
            verbose=self.verbose,
        ...
        if self.train_loc_enc:
            location_encoder.reset_model()
        sdm = EU_SDM(
            "/shares/wegner.ics.uzh/glc23_data/Pot_10_to_1000.csv",
            mlp_input_len=self.mlp_input_len,
            use_months=self.use_months,
            pass_month_to_forward=self.pass_month_to_forward,
            verbose=self.verbose,
