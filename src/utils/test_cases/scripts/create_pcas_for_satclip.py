...
def create_intermediate_npy_satCLIP(scope):
    ...
    model = get_satclip('/home/jdolli/chelsaCLIP/src/utils/test_cases/scripts/satclip-resnet18-l40.ckpt', device="cuda") #Only loads location encoder by default
    model.eval()
...
def create_map_visual_satCLIP(reduction, scope):
    ...
    plt.imsave("./utils/test_cases/data/satCLIP_" + reduction + "_" + scope + ".png", red)
