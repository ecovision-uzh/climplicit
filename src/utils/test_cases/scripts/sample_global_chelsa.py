...
file_name = (
    "/shares/wegner.ics.uzh/CHELSA/climatologies/1981-2010_numpy/03_monthly_float16.npy"
)
...
for i in tqdm(range(len(sample))):
    ...
    data[i][2:] = ras[:, y, x]
np.save(
    "/home/jdolli/chelsaCLIP/src/utils/test_cases/data/global_chelsa_" + str(SAMPLES),
    data,
)
