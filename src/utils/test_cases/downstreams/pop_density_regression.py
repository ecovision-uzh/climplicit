...
class PDR:
    ...
    def __call__(self, pos_embedding, location_encoder, wb, section="test/"):
        ...
        if wb:
            wb.log(
                {
                    "SatCLIP Regressions/pop_density_r2_mean": r2s.mean(),
                    "SatCLIP Regressions/pop_density_r2_std": r2s.std(),
                }
            )
        else:
...
if __name__ == "__main__":
    ...
    reg = PDR(
        "/home/jdolli/chelsaCLIP/src/utils/test_cases/data/pop_density_1000000.npy",
        mlp_input_len=4,
        use_months=True,
        verbose=True,
        iterations=1,
