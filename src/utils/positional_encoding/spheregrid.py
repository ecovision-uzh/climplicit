...
class SphereGridSpatialRelationEncoder(nn.Module):
    ...
    """
    def __init__(self, spa_embed_dim=None, coord_dim = 2, frequency_num = 16, 
...
if __name__ == "__main__":
    ...
    sg = SphereGridSpatialRelationEncoder(SPA_EMB, coord_dim = 2, frequency_num = FREQ_NUM, 
        max_radius = 100000, min_radius = 10,
            freq_init = "geometric",
            ffn=None, device = "cuda")
